                        ...
                        <td>
                          <div>
                            ...
                            <div className="text-xs text-muted" style={{ fontFamily: 'var(--font-mono)' }}>
                              <a href={`https://www.scanitprintit.in/s/${shop.slug}`} target="_blank" rel="noreferrer" style={{ color: 'var(--text-muted)', textDecoration: 'underline' }}>
